...
private:
    ...
    {
        cout << "increasing piston speed" << endl;
    }
    void decreasing_piston_speed()
    {
        cout << "decreasing piston speed" << endl;
    }
};

class electric_engine : public ic_engine
{
private:
    void acceleration_output() override { increasing_motor_speed(); };
    void reduce_output() override { decreasing_motor_speed(); };
    void increasing_motor_speed() { cout << "increasing motor speed" << endl; }
    void decreasing_motor_speed() { cout << "decreasing motor speed" << endl; }
};

class break_system
{
public:
    void pushing_break(accelerator &acceleartor_obj);
};
...
private:
    engine &my_engine;
    void reduce_output();
    friend void break_system::pushing_break(accelerator &acceleartor_obj);
};
...
{
public:
    cruise_controller(sensor &sensor, accelerator &accelerator, break_system &break_system) : my_sensor(sensor),
